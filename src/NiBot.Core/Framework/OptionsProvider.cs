using Aiursoft.NiBot.Core.Abstracts;
using System.CommandLine;

namespace Aiursoft.NiBot.Core.Framework;

public static class OptionsProvider
{
    public static readonly Option<string> PathOptions = new(
        aliases: new[] { "--path", "-p" },
        description: "Path of the program to run.")
    {
        IsRequired = true
    };
    ...
    public static RootCommand AddPlugins(this RootCommand command, params INiBotPlugin[] pluginInstallers)
    {
